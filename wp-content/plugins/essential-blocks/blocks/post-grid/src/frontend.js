...
function ebPaginationFunc(queryParamString) {
    ...
    if (isPagination.length > 0) {
        ...
        if (paginationButton.length > 0) {
            //
            document.querySelectorAll(".ebpostgrid-pagination").forEach((item) => {
                        ...
                        apiFetch({
                            ...
                            if (isLoadMore) {
                                if (!result) {
                                    ...
                                    this.closest(".ebpostgrid-pagination").innerHTML =
                                        "";
                                } else {
                                    this.closest(
                                        ".ebpostgrid-pagination"
...
function eb_handlePreviousNext(selector) {
    let pageNumber = 1;
    const active = selector.closest(".ebpostgrid-pagination")?.querySelector(".ebpg-pagination-item.active");
    if (active) {
                ...
                apiFetch({
                    ...
                    (result) => {
                        ...
                        if (totalPosts) {
                            ...
                            if (this.closest(".eb-post-grid-wrapper").querySelector(".ebpostgrid-pagination")) {
                                this.closest(".eb-post-grid-wrapper").querySelector(".ebpostgrid-pagination").innerHTML = "";
                            }
                            if (
                                this.closest(
                                    ".eb-post-grid-wrapper"
